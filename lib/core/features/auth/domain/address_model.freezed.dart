...
mixin _$AddressModel {
 ...
 String get street; String get city; String get state; String get country; String get postalCode; double? get latitude; double? get longitude; String? get placeId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,street,city,state,country,postalCode,latitude,longitude,placeId);

@override
String toString() {
  return 'AddressModel(street: $street, city: $city, state: $state, country: $country, postalCode: $postalCode, latitude: $latitude, longitude: $longitude, placeId: $placeId)';
}
...
@useResult
$Res call({
 String street, String city, String state, String country, String postalCode, double? latitude, double? longitude, String? placeId
});
...
/// Create a copy of AddressModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? street = null,Object? city = null,Object? state = null,Object? country = null,Object? postalCode = null,Object? latitude = freezed,Object? longitude = freezed,Object? placeId = freezed,}) {
...
class _AddressModel implements AddressModel {
  const _AddressModel({required this.street, required this.city, required this.state, required this.country, required this.postalCode, this.latitude, this.longitude, this.placeId});
...
/// Create a copy of AddressModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? street = null,Object? city = null,Object? state = null,Object? country = null,Object? postalCode = null,Object? latitude = freezed,Object? longitude = freezed,Object? placeId = freezed,}) {
