...
mixin _$EventModel {
 ...
 String get id; String get name;// EventTemplateModel? template,
@JsonKey(name: "start_time") DateTime get startTime;@JsonKey(name: "end_time") DateTime get endTime; AddressModel get address; List<String>? get tags; String? get description;@JsonKey(name: "image_url") String? get imageUrl;@JsonKey(includeToJson: false, includeFromJson: true, name: "created_at") DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,startTime,endTime,address,const DeepCollectionEquality().hash(tags),description,imageUrl,createdAt);

@override
String toString() {
  return 'EventModel(id: $id, name: $name, startTime: $startTime, endTime: $endTime, address: $address, tags: $tags, description: $description, imageUrl: $imageUrl, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String name,@JsonKey(name: "start_time") DateTime startTime,@JsonKey(name: "end_time") DateTime endTime, AddressModel address, List<String>? tags, String? description,@JsonKey(name: "image_url") String? imageUrl,@JsonKey(includeToJson: false, includeFromJson: true, name: "created_at") DateTime? createdAt
});
...
/// Create a copy of EventModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? startTime = null,Object? endTime = null,Object? address = null,Object? tags = freezed,Object? description = freezed,Object? imageUrl = freezed,Object? createdAt = freezed,}) {
...
class _EventModel implements EventModel {
  const _EventModel({required this.id, required this.name, @JsonKey(name: "start_time") required this.startTime, @JsonKey(name: "end_time") required this.endTime, required this.address, final  List<String>? tags, this.description, @JsonKey(name: "image_url") this.imageUrl, @JsonKey(includeToJson: false, includeFromJson: true, name: "created_at") this.createdAt}): _tags = tags;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,startTime,endTime,address,const DeepCollectionEquality().hash(_tags),description,imageUrl,createdAt);
...
/// Create a copy of EventModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? startTime = null,Object? endTime = null,Object? address = null,Object? tags = freezed,Object? description = freezed,Object? imageUrl = freezed,Object? createdAt = freezed,}) {
