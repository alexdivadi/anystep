              ...
              children: [
                Flexible(
                  child: AnyStepDateTimePicker(
                    ...
                    initialValue:
                        widget.event?.startTime ?? DateTime(now.year, now.month, now.day, 8, 0),
                    validator: FormBuilderValidators.compose([
                      FormBuilderValidators.required(),
                      (val) {
                        if (val != null && widget.event != null && val.isBefore(now)) {
                ...
                Flexible(
                  child: AnyStepDateTimePicker(
                    ...
                    initialValue:
                        widget.event?.endTime ?? DateTime(now.year, now.month, now.day, 9, 0),
                    validator: FormBuilderValidators.compose([
                      FormBuilderValidators.required(),
                      (val) {
                        if (val != null &&
