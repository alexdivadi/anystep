...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  int? id,  String street, @JsonKey(name: "street_secondary")  String? streetSecondary,  String city,  String state,  String? country, @JsonKey(name: "postal_code")  String postalCode, @JsonKey(name: "is_user_address")  bool isUserAddress,  double? latitude,  double? longitude, @JsonKey(name: "place_id")  String? placeId,  String? name,  String? geohash)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddressModel() when $default != null:
return $default(_that.id,_that.street,_that.streetSecondary,_that.city,_that.state,_that.country,_that.postalCode,_that.isUserAddress,_that.latitude,_that.longitude,_that.placeId,_that.name,_that.geohash);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  int? id,  String street, @JsonKey(name: "street_secondary")  String? streetSecondary,  String city,  String state,  String? country, @JsonKey(name: "postal_code")  String postalCode, @JsonKey(name: "is_user_address")  bool isUserAddress,  double? latitude,  double? longitude, @JsonKey(name: "place_id")  String? placeId,  String? name,  String? geohash)  $default,) {final _that = this;
switch (_that) {
case _AddressModel():
return $default(_that.id,_that.street,_that.streetSecondary,_that.city,_that.state,_that.country,_that.postalCode,_that.isUserAddress,_that.latitude,_that.longitude,_that.placeId,_that.name,_that.geohash);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false)  int? id,  String street, @JsonKey(name: "street_secondary")  String? streetSecondary,  String city,  String state,  String? country, @JsonKey(name: "postal_code")  String postalCode, @JsonKey(name: "is_user_address")  bool isUserAddress,  double? latitude,  double? longitude, @JsonKey(name: "place_id")  String? placeId,  String? name,  String? geohash)?  $default,) {final _that = this;
switch (_that) {
case _AddressModel() when $default != null:
return $default(_that.id,_that.street,_that.streetSecondary,_that.city,_that.state,_that.country,_that.postalCode,_that.isUserAddress,_that.latitude,_that.longitude,_that.placeId,_that.name,_that.geohash);case _:
  return null;
